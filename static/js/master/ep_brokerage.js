var t
t = $('#sub_brokerage_table_data').DataTable( {
  ajax: '/load_sub_brokerage_data',
        ...
        targets: [8], render: function (a, b, data, d){
            ...
            html = `<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <hr class="drop-hr">
                            <a class="dropdown-item" href="/edit_easy_partner_brokerage/${data.id}"><i class="fa fa-edit"></i> Edit</a>
                        </div>
                    </div>`
           return html
        },
