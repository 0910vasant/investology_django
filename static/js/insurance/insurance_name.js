...
t = $('#insurance_name_table').DataTable( {
  ajax: '/load_insurance_name',
        ...
        targets: [2], render: function (a, b, data, d){
            ...
            html = `<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <hr class="drop-hr">-->
                            <a class="dropdown-item edit_modal" data-toggle="modal" href="javascript:void(0);" data-target="#edit_insurace_name" data-id="${data.id}"><i class="fa fa-edit"></i> Edit</a>
                        </div>
                    </div>`
           return html
        },
